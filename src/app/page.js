...
export default function Home() {
  return (
    <div className="bg-[#0a192f]">
      {/* Hero Section - Added pt-32 to account for fixed header */}
      <section id="home" className="min-h-screen flex flex-col items-center justify-center gap-8 py-20 pt-32">
        <motion.div 
